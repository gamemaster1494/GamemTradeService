...
//    {
//        private int MAX_RESERVE = clsFunctions.CRATEBANKT_MAX_RESERVE;

//        private int MAX_RESERVE_DONATOR = clsFunctions.CRATEBANK_DONATOR_RESERVE;

//        private string Item_Type = "crates";

//        private string Default_Currency = "weapons";

//        public FriendAddedHandler FriendAddedHandler;

//        public ItemReserveHandler ItemReserveHandler;

//        private int Crates, Scrap, Weapons;

//        private bool ChooseDonate = false;

//        private int UserWepsAdded;
...
//        public CrateUserHandler(Bot bot, SteamID sid)
//            : base(bot, sid)
//        {
...
//                    if (clsFunctions.schema.GetItem(item.defindex).ItemName == "Mann Co. Supply Crate")
//                    {
...
//                    else
//                    {
//                        Bot.SteamFriends.SendChatMessage(OtherSID, type, "That is not a crate...");//send the sConversionResult of checking the item
//                    }//else
//                }//if (!Bot.dReserved.ContainsKey(Convert.ToUInt64(sLines[2])))
//                else
//                {
...
//                    break;//case "items"
//                case "crates":
//                    int iScrap = ItemsBotAdded / 5;
//                    TF2Currency tempCurns = new TF2Currency(0,0,0,iScrap);
//                    dePrice = tempCurns.ToMetal();
//                    break;
//            }//switch (Item_Type)
//            return dePrice;
//        }//CalculatePrice()
